...
class ShadowUsers {
    ...
    var users = [ViewProfile]()
    
    init(){
        let bo = ViewProfile(neoId: "bo", name: "Bo", age: 32)
            bo.kinksMatched = 3
            bo.city = "New York, NY"
        ...
        let dyson = ViewProfile(neoId: "dyson", name: "Dyson", age: 35)
        ...
        let kenzi = ViewProfile(neoId: "kenzi", name: "Kenzi", age: 22)
        ...
        let hale = ViewProfile(neoId: "hale", name: "Hale", age: 28)
            hale.kinksMatched = 2
