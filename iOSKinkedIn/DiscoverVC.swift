...
private let reuseIdentifier = "thProfile"
...
class DiscoverVC: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        let isCanLike = true
        //UserDefaults.standard.bool(forKey: UD_CAN_LIKE)
        if isCanLike {
    ...
    */
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: reuseIdentifier, for: indexPath) as! ProfileThumbnail
        let profile = profiles[indexPath.row]
        cell.setContent(profile)
        return cell
    }
